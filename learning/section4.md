- 项目准备
  ...
  + [更改文档图标](#更改文档图标)
- [首页](#首页)
  + [首页_导航栏的封装和使用](#首页_导航栏的封装和使用)
  + [首页_请求多个数据](#首页_请求多个数据)
  + [首页_轮播图的展示](#首页_轮播图的展示)
  + [首页_推荐信息的展示](#首页_推荐信息的展示)
  + [首页_特性类别的展示](#首页_特性类别的展示)
  + [首页_表格切换控制的封装](#首页_表格切换控制的封装)
  + [首页_保存商品的数据结构](#首页_保存商品的数据结构)
  + [首页_商品数据的请求和保存](#首页_商品数据的请求和保存)
  + [首页_商品数据的展示](#首页_商品数据的展示)
  + [商品数据的展示_样式](#商品数据的展示_样式)
  + [首页_TabControl切换商品](#首页_TabControl切换商品)
  + [实现手机端浏览](#实现手机端浏览)
  + Better-scoll
    - [Better-scoll的安装和使用](#Better-scoll的安装和使用)
    - [Better-scroll的基本使用](#Better-scroll的基本使用)
    - [Better-scroll的封装和使用](#Better-scroll的封装和使用)
  + [回到顶部](#回到顶部)
  + [回到顶部的显示和隐藏](#回到顶部的显示和隐藏)
  + [滚到底部加载更多](#滚到底部加载更多)
  + [滚动高度的重新计算](#滚动高度的重新计算)
    - [也可以手动重新计算](#也可以手动重新计算)
  + [防抖函数的处理](#防抖函数的处理)
    - [作用机理推测](#作用机理推测)
  + [TabControl的吸顶效果](#TabControl的吸顶效果)
  + [首页_离开时记录状态和位置](#首页_离开时记录状态和位置)
  + [首页_拖动底部导航栏丢失位置的问题](#首页_拖动底部导航栏丢失位置的问题)
  + [跳转到详情页](#跳转到详情页)
- 详情页  
  + [详情页_导航栏的封装](#详情页_导航栏的封装)
  + [详情页_数据请求以及轮播图的展示](#详情页_数据请求以及轮播图的展示)
  + [详情页_请求数据筛选与其的稳定渲染](#详情页_请求数据筛选与其的稳定渲染)
  + [详情页_店铺信息的展示](#详情页_店铺信息的展示)
  + [详情页_加入滚动的效果](#详情页_加入滚动的效果)
  + [详情页_商品图片数据的展示](#详情页_商品图片数据的展示)
  + [详情页_商品参数信息的展示](#详情页_商品参数信息的展示)
  + [详情页_商品评论信息的展示](#详情页_商品评论信息的展示)
  + [详情页_商品推荐的展示](#详情页_商品推荐的展示)
  + [解决共用组件导致的首页频繁监听事件](#解决共用组件导致的首页频繁监听事件)
  + [混入的简单使用](#混入的简单使用)
  + [详情页_主题跳转](#详情页_主题跳转)
  + [详情页_滚动内容改变标题](#详情页_滚动内容改变标题)
    - [详情页_滚动内容改变标题_双向绑定](#详情页_滚动内容改变标题_双向绑定)
  + [详情页_底部工具栏的展示](#详情页_底部工具栏的展示)
  + [详情页_回到顶部](#详情页_回到顶部)
  + [详情页_加购商品](#详情页_加购商品)
  + Vuex
    - [Vuex保存架构数据](#Vuex保存架构数据)
    - [Vuex代码的重构](#Vuex代码的重构)
- 购物车
  + [购物车_导航栏的实现](#购物车_导航栏的实现)
    - [购物车_导航栏的其它实现方法_mapGetters辅助函数](#购物车_导航栏的其它实现方法_mapGetters辅助函数)
  + [购物车_获取列表数据及滚动管理](#购物车_获取列表数据及滚动管理)
  + [购物车_商品列表的展示](#购物车_商品列表的展示)
  + [购物车_刷新滚动高度](#购物车_刷新滚动高度)
  + [购物车_按钮的状态改变](#购物车_按钮的状态改变)
  + [购物车_底部结算栏的展示](#购物车_底部结算栏的展示)
  + [购物车_全选按钮的状态管理](#购物车_全选按钮的状态管理)
  + [购物车_全选按钮的状态控制](#购物车_全选按钮的状态控制)
  + [加购消息的基本逻辑](#加购消息的基本逻辑)
  + Toast
    - [Toast的普通封装](#Toast的普通封装)
    - [Toast的插件封装](#Toast的插件封装)
- 优化  
  + [解决移动端300ms延迟——fastclick](#解决移动端300ms延迟——fastclick)
  + [图片懒加载——vue-lazyload框架](#图片懒加载——vue-lazyload框架)
  + [px2vw转化插件](#px2vw转化插件)
- 部署上线
  + [项目在window下的部署](#项目在window下的部署)
  + [项目在远程Linux下的部署](#项目在远程Linux下的部署)
- 其它  
  + [响应式原理的相关技术](#响应式原理的相关技术)
  + [通过Object.defineProperty监听对象属性的改变](#通过Object.defineProperty监听对象属性的改变)
  + [发布订阅者](#发布订阅者)
  + [其它补充](#其它补充)
  + [其它组件及薄弱补充](#其它组件及薄弱补充)
  + [代办项](#代办项)
